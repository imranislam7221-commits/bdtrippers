    ...
    <div className="container my-5">
      ...
      <div className="row mt-5 align-items-center">
        <div className="col-md-6">
          ...
          <ul className="list-group list-group-flush mb-3">
            <li className="list-group-item"><i className="fas fa-check text-success"></i> Fast-track Processing</li>
            <li className="list-group-item"><i className="fas fa-check text-success"></i> Hospital Coordination</li>
          </ul>
        </div>
        <div className="col-md-6 text-center">
          <div className="p-5 bg-light rounded border border-primary">
