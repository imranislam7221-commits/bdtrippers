          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body bg-light p-4 rounded">
              ...
              <ul className="list-unstyled mt-4">
                <li className="mb-3"><i className="fas fa-map-marker-alt text-primary me-2"></i> 123 Travel Avenue, Dhaka, Bangladesh</li>
                <li className="mb-3"><i className="fas fa-phone text-primary me-2"></i> +880 1711-000000</li>
                <li className="mb-3"><i className="fas fa-envelope text-primary me-2"></i> info@bdtrippers.com</li>
                <li className="mb-3"><i className="fab fa-whatsapp text-success me-2"></i> WhatsApp Available</li>
              </ul>
            </div>
          </div>
        </div>
